	...
	<tr>
		<td>
			<table border="0" width="950" cellspacing="5" cellpadding="0" bgcolor="#ffffff" align="center">
				<tr>
					<td colspan="3" background="picture/background.gif"  height="30" style="font-size:12pt;text-align:right">
_HEADER1;
				...
				<tr>
					<td colspan="3">
						<img border="0" src="picture/logonew.png" width="950" height="150"></a>
					</td>
				</tr>
				<tr>
					<td colspan="3" background="picture/background.gif" height="30" align="center">
				...
				<tr>
					...
					<img src="picture/notebook.jpg" width="190" height="100" /></br></br></br><hr/>
						<table align="center" >
...
_FOOTER3;
				...
				<tr>
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<font color="white"> Copyright &copy; 2012 PT. Tomo Lestari Citra </font>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
