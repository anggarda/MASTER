...
$query = mysql_query("SELECT * FROM t_order WHERE OrderDate BETWEEN '$year-$month-01' AND '$year-$month-$lastd_month ' ORDER BY OrderDate  ASC");
...
$query2 = "SELECT * FROM t_order WHERE OrderDate  BETWEEN '$year-$month-01 ' AND '$year-$month-$lastd_month ' ORDER BY OrderDate  ASC";
...
$query = "SELECT * FROM t_order WHERE OrderDate  BETWEEN '$year-$month-01 ' AND '$year-$month-$lastd_month ' ORDER BY OrderDate  ASC LIMIT $eu, $limit ";
