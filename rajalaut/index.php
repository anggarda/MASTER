...
pgHeader('Raja Laut | Home');

echo '<table align="center" width="550">
		<tr>
			<td>
			<!--
				<p align="justify">Toko Raja Laut <br />
				Menjual Produk Alat Pancing <br/>
				</p>
...
echo '<tr>
		<td colspan="2">
		<fieldset>
			<legend style="font-size:17;">Products Utama</legend><br/>';
		echo '<table border="0" cellspacing="0" cellpadding="3" align="center" width="500">';
				$sql    = "SELECT * FROM t_product WHERE ProdType='Reel' ORDER BY ProdID DESC ";
